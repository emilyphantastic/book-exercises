...
intro_panel <- tabPanel(
  ...
  img(src = "ineuality.png", alt = "Example NYT chart"),

  # A paragraph containing a hyperlink `a()` to the source of the article at
  # https://www.nytimes.com/interactive/2017/08/07/opinion/leonhardt-income-inequality.html
  P(
    a(
      href = "https://www.nytimes.com/interactive/2017/08/07/opinion/leonhardt-income-inequality.html", "(source)"
    )
  )
)
...
sidebar_content <- sidebarPanel(
  ...
  slideInput(inputID = "percentile", label = "Income Percentile",
